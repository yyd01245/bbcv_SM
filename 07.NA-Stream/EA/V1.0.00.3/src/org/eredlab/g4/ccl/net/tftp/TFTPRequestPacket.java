...
public abstract class TFTPRequestPacket extends TFTPPacket
{
     ...
     * by the transfer mode prod.nebula.constants.
     ***/
    static final String[] _modeStrings = { "netascii", "octet" };

    /***
     * A null terminated byte array representation of the ascii names of the
     * transfer mode prod.nebula.constants.  This is convenient for creating the TFTP
     * request packets.
     ***/
     ...
     *        class MODE prod.nebula.constants (e.g., TFTP.NETASCII_MODE).
     ***/
     ...
     * wants to implement his own TFTP tcpClient instead of using
