...
/***
 * The NTPUDPClient class is a UDP implementation of a tcpClient for the
...
public final class NTPUDPClient extends DatagramSocketClient
{
    ...
    /***
     * Returns the NTP protocol version number that tcpClient sets on request packet
     * that is sent to remote host (e.g. 3=NTP v3, 4=NTP v4, etc.)
     *
     * @return  the NTP protocol version number that tcpClient sets on request packet.
     * @see #setVersion(int)
     ***/
    ...
    /***
     * Sets the NTP protocol version number that tcpClient sets on request packet
