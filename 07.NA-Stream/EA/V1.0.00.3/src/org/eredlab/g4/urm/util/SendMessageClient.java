...
public class SendMessageClient {
	...
	public SendMessageClient(String changeTable,String changeType,String key,String value){
	...
	public void send(){
      ...
      public static void main(String[] args) {
    	  ...
    	  SendMessageClient s = new SendMessageClient(Contents.AD,Contents.DELETE,"id","1");  
    	  s.send();
	}
