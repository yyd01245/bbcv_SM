...
//	protected IReader smReader = (IReader) getService("smReader");
	protected IReader urmReader = (IReader) getService("urmReader");
//	protected IReader rcmReader = (IReader) getService("rcmReader");
//	protected IReader mtapReader = (IReader) getService("mtapReader");
//	public static IReader cssReader = (IReader) getService("cssReader");
//	protected IReader mtpReader = (IReader) getService("mtpReader");
	public static IReader crsmReader = (IReader) getService("crsmReader");
	 ...
	 * @return Object
	 */
	protected static Object getService(String pBeanId) {
