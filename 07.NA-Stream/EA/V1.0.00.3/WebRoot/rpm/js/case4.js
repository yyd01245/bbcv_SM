...
function openWindow(id,status){
		...
		if(status==2){
     	...
     	button="<a href='applicationMonitor.ered?reqCode=ctasInit' class='submitBt'>"+"跳转到应用"+"</a>";
     	if(status==2){
     		if(id==3||id==7){
     	...
     	if(flag){
     		...
     		data2 = [
     	      ["AIM",state,runtime,button],
     	      ["CABS","<font color='green'>正常</font>",runtime,button],
     	      ["CSCS",state,runtime,button],
     	      ["CUMS",state,runtime,button],
     	      ["URM","<font color='green'>正常</font>",runtime,button]
     	       			];
     	}
