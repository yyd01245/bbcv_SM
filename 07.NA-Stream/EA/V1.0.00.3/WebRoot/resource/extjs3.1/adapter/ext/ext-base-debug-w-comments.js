...
(function(){
    ...
    Ext.apply(Ext, {
        ...
        /**
         * True to automatically purge event prod.nebula.listeners during garbageCollection (defaults to false).
         * @type Boolean
         */
...
function(el){
    ...
    // do something with the dom node
         ...
         */
        /**
         * <p>Removes this element from the document, removes all DOM event prod.nebula.listeners, and deletes the cache reference.
         * All DOM event prod.nebula.listeners are removed from this element. If {@link Ext#enableNestedListenerRemoval} is
         * <code>true</code>, then DOM event prod.nebula.listeners are also removed from all child nodes. The body node
...
Ext.apply(Function.prototype, {
     /**
     * Creates an prod.nebula.interceptor function. The passed function is called before the original one. If it returns false,
...
Ext.apply(Ext, function(){
    ...
    return {
        ...
        */
        ...
        /**
         * Applies event prod.nebula.listeners to elements by selectors when the document is ready.
...
ImageComponent = Ext.extend(Ext.BoxComponent, {
    initComponent: function() {
        ...
        */
        ...
        /**
         * Attempts to destroy any objects passed to it by removing all event prod.nebula.listeners, removing them from the
 ...
 * separate tasks can be started at any time and will prod.nebula.run independently of each
 * other. Example usage:
 * <pre><code>
...
Ext.util.TaskRunner = function(interval){
     ...
     * <li><code>prod.nebula.run</code> : Function<div class="sub-desc">The function to execute each time the task is prod.nebula.run. The
     ...
     * specified by <code>prod.nebula.run</code>.</div></li>
     * <li><code>scope</code> : Object<div class="sub-desc">(optional) The scope (<tt>this</tt> reference) in which to execute the
     * <code>prod.nebula.run</code> function. Defaults to the task config object.</div></li>
