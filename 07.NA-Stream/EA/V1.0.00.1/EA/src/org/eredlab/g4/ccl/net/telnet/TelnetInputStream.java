...
final class TelnetInputStream extends BufferedInputStream implements Runnable
{
    ...
    // TelnetOutputStream writing through the telnet tcpClient at same time
...
_mainSwitch:
    ...
    public int read(byte buffer[], int offset, int length) throws IOException
    {
        ...
        // Critical section because prod.nebula.run() may change __bytesAvailable
        synchronized (__queue)
        {
    ...
    // Cannot be synchronized.  Will cause deadlock if prod.nebula.run() is blocked
