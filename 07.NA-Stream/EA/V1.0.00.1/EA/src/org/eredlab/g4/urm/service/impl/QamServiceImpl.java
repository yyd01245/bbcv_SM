...
//			List networkList = urmDao.queryForList("Qam.getNerworkById", pDto);
//			if(networkList.size()>0){
//				Dto inDto = (Dto) networkList.get(0);
//				String area_id = inDto.getAsString("area_id");
//				String region_id = inDto.getAsString("sg_id");
//				String ipqam_level;
...
//					ipqam_level="1";
//				}
//				pDto.put("ipqam_level", ipqam_level);
//			}
...
//			pDto.put("ipqam_id", ipqamid);
			...
			urmDao.insert("Qam.saveQamItem", pDto);
			 ...
			 SendMessageClient s = new SendMessageClient(Contents.IPQAMINFO,Contents.INSERT);  
			  s.send();
//			String busi_id = IDHelper.getCodeID();
	...
	public Dto updateQamItem(Dto pDto) {
		...
		//	String	state           = pDto.getAsString("state");
			...
			urmDao.update("Qam.updateQamItem", pDto);
			 ...
			 SendMessageClient s = new SendMessageClient(Contents.IPQAMINFO,Contents.UPDATE);  
			  s.send();
