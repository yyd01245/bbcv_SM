 ...
 * own FTP tcpClient.  It extends org.apache.commons.net.TelnetClient
 ...
 * derived from FTP,
 * implements all the functionality required of an FTP tcpClient.  The
 * FTP class is made public to provide access to various FTP prod.nebula.constants
...
public class FTP extends TelnetClient
{
     ...
     * be treated as ASCII.  This is the default file type.  All prod.nebula.constants
     ...
     * EBCDIC formats.  All prod.nebula.constants ending in <code>FILE_TYPE</code>
     ...
     * performed.  All prod.nebula.constants ending in <code>FILE_TYPE</code> are used to
     * indicate file types.
     ***/
    ...
    /***
     * A constant used to indicate the file(s) being transfered should
     * be treated as a local type.  All prod.nebula.constants ending in
     ...
     * All prod.nebula.constants ending in <code>TEXT_FORMAT</code> are used to indicate
     ...
     * sequence of bytes.  This is the default structure.  All prod.nebula.constants ending
     ...
     * of records.  All prod.nebula.constants ending in <code>_STRUCTURE</code>
     ...
     * independent indexed pages.  All prod.nebula.constants ending in
     ...
     * of bytes.  This is the default transfer mode.  All prod.nebula.constants ending
     ...
     * of blocks.  All prod.nebula.constants ending in <code>TRANSFER_MODE</code> are used
     ...
     * compressed data.  All prod.nebula.constants ending in <code>TRANSFER_MODE</code>
    ...
    private void __getReply() throws IOException
    {
        ...
        // In case we prod.nebula.run into an anomaly we don't want fatal index exceptions
        // to be thrown.
        length = line.length();
        if (length < 3)
     ...
     * method if you are implementing your own FTP tcpClient or if you need to
     ...
     *         <code>TRANSFER_MODE</code> prod.nebula.constants).
     * @return The reply code received from the server.
     * @exception FTPConnectionClosedException
     *      If the FTP server prematurely closes the connection as a result
     *      of the tcpClient being idle or some other reason causing the server
