 ...
 *    try {
 *      int reply;
 *      tcpClient.connect("mail.foobar.com");
 *      System.out.print(tcpClient.getReplyString());
 *
 *      // After connection attempt, you should check the reply code to verify
 *      // success.
 *      reply = tcpClient.getReplyCode();
 *
...
public class SMTPClient extends SMTP
{
     ...
     * writer.close();
     * if(!tcpClient.completePendingCommand()) // failure
     *   return false;
     * </pre>
     * <p>
    ...
    /***
     * Login to the SMTP server by sending the HELO command with the
     * tcpClient hostname as an argument.  Before performing any mail commands,
     * you must first login.
     * <p>
     * @return True if successfully completed, false if not.
     * @exception SMTPConnectionClosedException
