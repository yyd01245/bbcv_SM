...
public class IDaoImpl extends SqlMapClientDaoSupport implements IDao {
	...
	public void batchInsert(String statementName, List list)throws Exception{
		if(list!=null){
			SqlMapClient client = getSqlMapClientTemplate().getSqlMapClient();//.insert(statementName, new BaseDto());
			client.startBatch();
