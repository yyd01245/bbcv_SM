...
public class IDHelper {
	 ...
	 * 云应用ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_caasyunappid = null;
	/**
	 * 频道管理
	 */
	private static DefaultIDGenerator defaultIDGenerator_mtapchannelid = null;
	/**
	 * 频点ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_rfcodeid = null;
	/**
	 * 网络区域ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_networkid = null;
	/**
	 * 服务ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_serverid = null;
	/**
	 * 管理端ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_cumsid = null;
	/**
	 * 外部应用ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_appaccessid = null;
	/**
	 * IPQAMID
	 */
	private static DefaultIDGenerator defaultIDGenerator_urmipqamid = null;
	/**
	 * 应用组信息管理ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_cabsappgroupmanagerid = null;
	
	/**
	 * 升级包管理ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_cabspackageversionid = null;
	
	/**
	 * 升级策略管理ID
	 */
	private static DefaultIDGenerator defaultIDGenerator_cabsupdatestrategyid = null;
	
	/**
	 * 
	 */
	private static DefaultIDGenerator defaultIDGenerator_cabstermversionid = null;
	...
	static {
		IdGenerator idGenerator_caasyunappid = new IdGenerator();
		idGenerator_caasyunappid.setFieldname("CAASYUNAPPID");
		defaultIDGenerator_caasyunappid = idGenerator_caasyunappid.getDefaultIDGenerator();
	}
	static {
		IdGenerator idGenerator_mtapchannelid = new IdGenerator();
		idGenerator_mtapchannelid.setFieldname("MTAPCHANNELID");
		defaultIDGenerator_mtapchannelid = idGenerator_mtapchannelid.getDefaultIDGenerator();
	}
	static {
		IdGenerator idGenerator_rfcodeid = new IdGenerator();
		idGenerator_rfcodeid.setFieldname("RFCODEID");
		defaultIDGenerator_rfcodeid = idGenerator_rfcodeid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_networkid = new IdGenerator();
		idGenerator_networkid.setFieldname("NETWORKID");
		defaultIDGenerator_networkid = idGenerator_networkid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_serverid = new IdGenerator();
		idGenerator_serverid.setFieldname("SERVERID");
		defaultIDGenerator_serverid = idGenerator_serverid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_cumsid = new IdGenerator();
		idGenerator_cumsid.setFieldname("CUMSID");
		defaultIDGenerator_cumsid = idGenerator_cumsid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_appaccessid = new IdGenerator();
		idGenerator_appaccessid.setFieldname("APPACCESSID");
		defaultIDGenerator_appaccessid = idGenerator_appaccessid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_urmipqamid = new IdGenerator();
		idGenerator_urmipqamid.setFieldname("URMIPQAMID");
		defaultIDGenerator_urmipqamid = idGenerator_urmipqamid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_cabsappgroupmanagerid = new IdGenerator();
		idGenerator_cabsappgroupmanagerid.setFieldname("CABSAPPGROUPMANAGERID");
		defaultIDGenerator_cabsappgroupmanagerid = idGenerator_cabsappgroupmanagerid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_cabspackageversionid = new IdGenerator();
		idGenerator_cabspackageversionid.setFieldname("CABSPACKAGEVERSIONID");
		defaultIDGenerator_cabspackageversionid = idGenerator_cabspackageversionid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_cabsupdatestrategyid = new IdGenerator();
		idGenerator_cabsupdatestrategyid.setFieldname("CABSUPDATESTRATEGYID");
		defaultIDGenerator_cabsupdatestrategyid = idGenerator_cabsupdatestrategyid.getDefaultIDGenerator();
	}
	
	static {
		IdGenerator idGenerator_cabstermversionid = new IdGenerator();
		idGenerator_cabstermversionid.setFieldname("CABSTERMVERSIONID");
		defaultIDGenerator_cabstermversionid = idGenerator_cabstermversionid.getDefaultIDGenerator();
	}
	 ...
	 * @return
	 */
	public static String getYunAppID() {
		return defaultIDGenerator_caasyunappid.create();
	}
	/**
	 * 返回频道ID
	 * 
	 * @return
	 */
	public static String getMtapChannelID() {
		return defaultIDGenerator_mtapchannelid.create();
	}
	 ...
	 * @return
	 */
	public static String getRfCodeID() {
		return defaultIDGenerator_rfcodeid.create();
	}
	/**
	 * 返回网络区域ID
	 * 
	...
	public static String getnetworkID() {
		return defaultIDGenerator_networkid.create();
	}
	/**
	 * 返回服务ID
	 * 
	...
	public static String getSERVERID() {
		return defaultIDGenerator_serverid.create();
	}
	/**
	 * 返回控制端ID
	 * 
	 * @return
	 */
	public static String getCUMSID() {
		return defaultIDGenerator_cumsid.create();
	}
	 ...
	 * @return
	 */
	public static String getIPQAMID() {
		return defaultIDGenerator_urmipqamid.create();
	}
	/**
	 * 返回CUMSCONNECTID
	 * 
	 ...
	 * 返回应用组管理ID
	 */
	public static String getAppGroupManagerID(){
		return defaultIDGenerator_cabsappgroupmanagerid.create();
	}
	
	/**
	 * 返回升级包管理ID
	 */
	public static String getPackageVersionID(){
		return defaultIDGenerator_cabspackageversionid.create();
	}
	
	/**
	 * 返回升级策略管理ID
	 */
	public static String getUpdateStrategyID(){
		return defaultIDGenerator_cabsupdatestrategyid.create();
	}	
	
	public static String getTermVersionID(){
		return defaultIDGenerator_cabstermversionid.create();
	}
	 ...
	 * @return
	 */
	public static String getAppAccessID() {
		return defaultIDGenerator_appaccessid.create();
	}
}
