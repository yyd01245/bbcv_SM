...
Ext.onReady(function() {
	...
	var grid = new Ext.grid.GridPanel({
				title : '<span style="font-weight:bold">菜单信息表</span>',
	...
	function saveMenuItem() {
		...
		addMenuFormPanel.form.submit({
					...
					failure : function(form, action) {
						...
						Ext.MessageBox.show({title:'提示',msg: '菜单数据保存失败:<br>' + msg,buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});
					}
				});
	}
	...
	function editInit() {
		...
		if (Ext.isEmpty(record)) {
			Ext.Msg.show({title:'提示',msg:'请先选择您要修改的菜单项目!',buttons:Ext.Msg.OK,icon:Ext.Msg.WARNING});
								
			return;
		}
		record = grid.getSelectionModel().getSelected();
		if (record.get('menutype') == '1') {
			Ext.Msg.show({title:'提示',msg: '您选中的记录为系统内置菜单,不允许修改!',buttons:Ext.Msg.OK,icon:Ext.Msg.WARNING});				
			return;
		}
		...
		addMenuWindow.show();
		addMenuWindow.setTitle('<span style="font-weight:bold">修改菜单</span>');
	...
	function addInit() {
		...
		addMenuWindow.show();
		addMenuWindow.setTitle('<span style="font-weight:bold">新增菜单</span>');
	...
	function update() {
		...
		addMenuFormPanel.form.submit({
					...
					failure : function(form, action) {
						var msg = action.result.msg;
						Ext.Msg.show({title:'提示',msg: '菜单数据修改失败:<br>' + msg,buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});
