...
public class FTPFile implements Serializable
{
    ...
    /***
     * Return the type of the file (one of the <code>_TYPE</code> prod.nebula.constants),
     ...
     * prod.nebula.constants) has the given access permission (one of the
     * <code> _PERMISSION </code> prod.nebula.constants) to the file.
     * <p>
     ...
     *               <code> _PERMISSION </code> prod.nebula.constants)
