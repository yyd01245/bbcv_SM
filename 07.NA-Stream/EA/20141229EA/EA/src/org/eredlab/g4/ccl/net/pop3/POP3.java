 ...
 * only so that you may easily implement your own POP3 tcpClient if
...
public class POP3 extends SocketClient
{
    ...
    /***
     * A constant representing the state where the tcpClient is not yet connected
     * to a POP3 server.
     ***/
    ...
    /***
     * Sets POP3 tcpClient state.  This must be one of the
     * <code>_STATE</code> prod.nebula.constants.
     * <p>
    ...
    /***
     * Returns the current POP3 tcpClient state.
     * <p>
     * @return The current POP3 tcpClient state.
     ***/
    public int getState()
    {
        return __popState;
    ...
    /***
     * Disconnects the tcpClient from the server, and sets the state to
     ...
     * <p>
     * @param command  The POP3 command to send
     *                  (one of the POP3Command prod.nebula.constants).
     * @param args     The command arguments.
     * @return  The server reply code (either POP3Reply.OK or POP3Reply.ERROR).
     ***/
     ...
     * your own tcpClient using the {@link #sendCommand  sendCommand } methods.
     * <p>
