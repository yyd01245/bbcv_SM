...
import prod.nebula.eabg.util.BusistpUserSubscriber;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public BusistpUserSubscriber getAsBusistpUserSubscriber(String key) {
		Object obj = TypeCaseHelper.convert(get(key), "BusistpUserSubscriber", null);
		if (obj != null)
			return (BusistpUserSubscriber) obj;
		else
			return null;
	}
	public void BusistpUserSubscriber(BusistpUserSubscriber busistpUserSubsctiber){
		put("bus",busistpUserSubsctiber);
	}
	public BusistpUserSubscriber getBusistpUserSubscriber(){
		return getAsBusistpUserSubscriber("bus");
	}
}
