...
function addTab(url,name,menuid,pathCh,icon){
  ...
  if (!n) {
     ...
     n = mainTabs.add({
       ...
       html:'<iframe id='+id_1+' scrolling="auto" frameborder="0" width="100%" height="100%" src='+url+'></iframe>'
...
<tr>
<td width="65%"><nobr>&nbsp;<img class="IEPNG" src="./resource/image/ext/comments2.png" />&nbsp;欢迎您,${username}!&nbsp;帐户:${account}&nbsp;所属组织:${deptname}</nobr></td>
