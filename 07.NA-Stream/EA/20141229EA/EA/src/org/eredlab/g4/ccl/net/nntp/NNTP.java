 ...
 * only so that you may easily implement your own NNTP tcpClient if
 ...
 * The NNTP class is made public to provide access to various NNTP prod.nebula.constants
...
public class NNTP extends SocketClient
{
     ...
     * if the tcpClient is allowed to post to the server.  Initializes
    ...
    /***
     * Indicates whether or not the tcpClient is allowed to post articles to
     * the server it is currently connected to.
     * <p>
     * @return True if the tcpClient can post articles to the server, false
     *         otherwise.
     ***/
     ...
     * method if you are implementing your own NNTP tcpClient or if you need to
