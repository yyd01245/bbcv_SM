...
Ext.onReady(function() {
	...
	var deptTree = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : 'rolePart.ered?reqCode=departmentTreeInit'
						}),
				root : root,
				title : '',
				applyTo : 'deptTreeDiv',
	...
	var viewport = new Ext.Viewport({
				layout : 'border',
				items : [{
							title : '<span style="font-weight:bold;">组织机构</span>',
	...
	function saveData() {
		...
		Ext.Ajax.request({
					...
					failure : function(response) {
						Ext.MessageBox.show({title:'提示',msg:'数据保存失败!',buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});
					},
					params : {
