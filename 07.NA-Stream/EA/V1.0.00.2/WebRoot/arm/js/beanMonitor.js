...
Ext.onReady(function() {
	...
	var grid = new Ext.grid.GridPanel({
				title : '<span style="font-weight:bold;">Service监控</span>',
				height : 500,
				// width:600,
				iconCls : 'pluginIcon',
				autoScroll : true,
				...
				tbar : [{
					...
					format : 'Y-m-d',
					width : 100
				}, '-', advisetypeCombo, '-', new Ext.form.TextField({
							id : 'keyword',
							name : 'keyword',
							emptyText : '关键字过滤',
	...
	if (runMode == '0') {
		Ext.Msg.show({title:'提示',	msg:'为保障演示系统高速运行,监控功能已关闭.您看到的数据是历史监控数据!',
								buttons:Ext.Msg.OK,icon:Ext.Msg.WARNING});
	}
