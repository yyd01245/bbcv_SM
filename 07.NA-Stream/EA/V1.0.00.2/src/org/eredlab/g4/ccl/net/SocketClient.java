 ...
 * tcpClient objects accessing sockets.  It is meant to be
...
public abstract class SocketClient
{
    ...
    /**
     * A status variable indicating if the tcpClient's socket is currently open.
     */
    protected boolean _isConnected_;

    /** The default port the tcpClient should connect to. */
    ...
    /**
     * Returns true if the tcpClient is currently connected to a server.
     * <p>
     * @return True if the tcpClient is currently connected to a server,
     *         false otherwise.
     */
    ...
    /**
     * Returns the local address to which the tcpClient's socket is bound.
     * <p>
     * @return The local address to which the tcpClient's socket is bound.
     */
    ...
    /**
     * Returns the port number of the remote host to which the tcpClient is
     * connected.
     * <p>
     * @return The port number of the remote host to which the tcpClient is
     *         connected.
     */
    ...
    /**
     * @return The remote address to which the tcpClient is connected.
     */
     ...
     * is useful for doing a quick security check when a tcpClient needs to
