...
/**
 * The CopyStreamAdapter will relay CopyStreamEvents to a list of prod.nebula.listeners
 ...
 * org.apache.commons.io.Util to multiple prod.nebula.listeners.  The static
 * copyStream() methods invoke the
 * bytesTransfered(long, int) of a CopyStreamListener for performance
 * reasons and also because multiple prod.nebula.listeners cannot be registered given
...
public class CopyStreamAdapter implements CopyStreamListener
{
     ...
     * the event to all of its registered prod.nebula.listeners, listing itself as the
     * source of the event.
     ...
     * prod.nebula.listeners, listing itself as the source of the event.
