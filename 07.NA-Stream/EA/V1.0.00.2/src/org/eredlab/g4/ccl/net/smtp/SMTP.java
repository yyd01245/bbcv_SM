 ...
 * own SMTP tcpClient.  To derive the full benefits of the SMTP class requires
 ...
 * derived from SMTP,
 * implements all the functionality required of an SMTP tcpClient.  The
 * SMTP class is made public to provide access to various SMTP prod.nebula.constants
...
public class SMTP extends SocketClient
{
     ...
     * method if you are implementing your own SMTP tcpClient or if you need to
