...
public class SkipServlet extends HttpServlet {
	...
	try {
		...
		String showname = nickname==null?username:nickname;
...
//			ops.flush();
		    ...
		    String tv_detail=	PropertiesUtil.readValue("tv.detail.url")+"&username="+showname+"&"+"streamid="+streamid+"&pageName="+pageName;
