...
<head>
    ...
    <title>高清导航页</title>
    <link rel="stylesheet" href="blurbg/style/clstyle_jingdian.css"/>
...
<%--打印日志--%>
 <%Logger logger = LoggerFactory.getLogger("");
   logger.info("【导航页日志】流化TV导航页面【streamid="+streamid+"】，【高清经典频道（微信）】"); %>

 <script>


 function queryStatus(){    
	 var pageName = "jingdian";
...
<script type="text/javascript" src="<%= base%>res/data/hd_vod_jingdian.js"></script>
