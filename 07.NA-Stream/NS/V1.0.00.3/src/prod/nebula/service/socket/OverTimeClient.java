...
public class OverTimeClient {
	...
	public void send(String id){
		try {
		    ...
		    os.close();  
		    socket.close();
		    logger.info("【NS-OverTimeClient】向SM服务器【"+serverIp+":"+serverPort+"】发送成功 ");
		
		} catch (UnknownHostException e) {	
		    logger.error("【NS-OverTimeClient】[UnknownHostException],与SM服务器【"+serverIp+":"+serverPort+"】连接失败");
			
		} catch (IOException e) {
			 logger.error("【NS-OverTimeClient】[IOException],与SM服务器【"+serverIp+":"+serverPort+"】连接失败");
		}
