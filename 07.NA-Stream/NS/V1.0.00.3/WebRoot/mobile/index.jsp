	...
	$(document).ready(function() {
		...
		$.each(data,function(i,ele){
			...
			source.forEach(function(element){
				htmlcontent+='<li><a href="<%=basePath%>mobile/ShowVodInfo?flag=set&resolution=<%=resolution%>&username=<%=username%>&streamid=<%=streamid%>&vodid='+element.id+'&name='+element.id+'"+"><img src="'+element.mbPosterPath2+'"><h3>'+element.name+'</h3><h3><small>迷失的刀郎 之 狼爱上羊</small></h3></a></li>';
			})	
