...
<body class="detail">
    ...
    <div id="detailInfo">
    	<img id="poster" src="${vod.littlePosterPath}" width="120" class="img" />
        <div>
			<ul>
...
<%--	})--%>
	...
	//alert("测试");
		$.ajax( {
        url: "<%=basePath%>TransitionServlet?thisState=1&username=<%=username%>", //这里是静态页的地址
...
<%--		 --%>
     //  setTimeout("kysxplay(rstp);",2000);
	   ...
	   var rstp1 = "rstp:"+rstp;
	    ...
	    var posterurl = "posterurl:"+currentEle.poster;
