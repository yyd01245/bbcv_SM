	...
	<div class="advert_page">
		<div class="contair">
			<div class="play_advert">
				...
				<div class="marquee">
					<div class="runtext">
						<div id ="scroll" style="width:1200px;margin-left:100px;">用户<span>(<%=username%>)</span>暂停操作中,请按<img src="images/button.png">继续操作(<span id="endtime"><span style="color:darkorange">30</span></span>)</div>
					</div>
				</div>
			</div>
