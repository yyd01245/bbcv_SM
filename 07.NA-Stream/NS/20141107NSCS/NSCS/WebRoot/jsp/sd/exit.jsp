...
.container{
	width:720px;
	height:576px;
	background:url(exit.jpg) no-repeat;
...
<!--<div class="video">
	...
	%>
	<p align="center" style="font-size: 20;padding-left: 5px;padding-top: 430px;"><span id="endtime">9</span>秒后自动结束播放</p>
    ...
    if (iTime >= 0)
    {
        ...
        if(iTime==0){
        	...
        	<% String  streamid =request.getParameter("streamid");%> 
        	  window.location.href="<%=basePath%>QuitServlet?streamid=<%=streamid%>&username=<%=username2%>"; 
