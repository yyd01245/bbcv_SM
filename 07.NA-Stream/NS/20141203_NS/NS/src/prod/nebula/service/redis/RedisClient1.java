...
public class RedisClient1 {
	 ...
	 private Jedis jedis;//非切片额客户端连接
	    ...
	    { 
	        ...
	        jedisPool = new JedisPool(config,"127.0.0.1",13170);
	    ...
	    { 
	        ...
	        shards.add(new JedisShardInfo("127.0.0.1", 13170, "1234")); 
	    ...
	    public void KeyOperate() {
	  	...
	  	public static void main(String[] args) {
			...
			RedisClient1 r=	   new RedisClient1(); 
