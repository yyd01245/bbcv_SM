...
<head>
    ...
    <title>高清导航页</title>
    <link rel="stylesheet" href="blurbg/style/clstyle_jiaoyu.css"/>
...
<%--打印日志--%>
 ...
 <%Logger logger = LoggerFactory.getLogger("");
   logger.info("【导航页日志】流化TV导航页面【streamid="+streamid+"】，【高清教育频道（微信）】"); %>
...
<script type="text/javascript" src="<%= base%>res/data/hd_vod_jiaoyu.js"></script>
