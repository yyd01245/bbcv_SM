...
public class SignalingGetewayConfigAction extends BaseAction {

	
	private static Log log = LogFactory.getLog(SignalingGetewayConfigAction.class);
	
	
	private SignalingGatewayConfigService signalingGatewayConfigService = (SignalingGatewayConfigService)super.getService("signalingGatewayConfigService");
	...
	public ActionForward queryGatewayConfigList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		List objectList = urmReader.queryForList("SignalingGatewayConfig.getGatewayConfigList", inDto);
	...
	public ActionForward queryGatewayConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		List objectList = urmReader.queryForList("SignalingGatewayConfig.queryGatewayConfig", inDto);
		if(objectList.size()>0){
	...
	public ActionForward saveAccessGatewayConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		Dto outDto = signalingGatewayConfigService.savaGatewayConfig(inDto);
	...
	public ActionForward updateAccessGatewayConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		Dto outDto = signalingGatewayConfigService.updateGatewayConfigById(inDto);
		String retString = JsonHelper.encodeObject2Json(outDto);
		write(retString, response);
		return mapping.findForward(null);
	}
	...
	public ActionForward authAccessGatewayConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		Dto outDto = signalingGatewayConfigService.authGatewayConfigById(inDto);
		String retString = JsonHelper.encodeObject2Json(outDto);
		write(retString, response);
		return mapping.findForward(null);
	}
