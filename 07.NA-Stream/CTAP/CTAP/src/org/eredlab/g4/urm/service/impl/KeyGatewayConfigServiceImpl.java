...
public class KeyGatewayConfigServiceImpl extends BaseServiceImpl implements
		KeyGatewayConfigService {
	
	
	
	Log logger = LogFactory.getLog(KeyGatewayConfigServiceImpl.class);
	...
	public Dto savaGatewayConfig(Dto inDto) {
		...
		urmDao.insert("KeyGatewayConfig.saveAccessGatewayConfig", inDto);	
	...
	public Dto updateGatewayConfigById(Dto inDto) {
		...
		urmDao.update("KeyGatewayConfig.updateAccessGatewayConfigById", inDto);	
		outDto.put("success", TRUE);		
		return outDto;
	...
	public Dto authGatewayConfigById(Dto inDto) {
		...
		urmDao.update("KeyGatewayConfig.authAccessGatewayConfigById", inDto);	
		outDto.put("success", TRUE);	
		return null;
	}
