...
public class AccessGatewayConfigServiceImpl extends BaseServiceImpl implements
		AccessGatewayConfigService {
	
	
	
	Log logger = LogFactory.getLog(AccessGatewayConfigServiceImpl.class);
	...
	public Dto savaGatewayConfig(Dto inDto) {
		...
		urmDao.insert("AccessGatewayConfig.saveAccessGatewayConfig", inDto);	
	...
	public Dto updateGatewayConfigById(Dto inDto) {
		...
		urmDao.update("AccessGatewayConfig.updateAccessGatewayConfigById", inDto);	
		outDto.put("success", TRUE);		
		return outDto;
	...
	public Dto authGatewayConfigById(Dto inDto) {
		...
		urmDao.update("AccessGatewayConfig.authAccessGatewayConfigById", inDto);	
		outDto.put("success", TRUE);	
		return null;
	}
