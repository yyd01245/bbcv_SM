...
public class AccessGetewayConfigAction extends BaseAction {

	
	private static Log log = LogFactory.getLog(AccessGetewayConfigAction.class);
	...
	public ActionForward queryGatewayConfigList(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		List objectList = urmReader.queryForList("AccessGatewayConfig.getGatewayConfigList", inDto);
	...
	public ActionForward queryGatewayConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		List objectList = urmReader.queryForList("AccessGatewayConfig.queryGatewayConfig", inDto);
		if(objectList.size()>0){
