...
public class FcfConstant {
	 ...
	 * 线性滚动图
	 */
	private static final String SCROLL_LINE = "SCROLL_L";
	
	private static final String SCROLL_COLUMN = "SCROLL_C";
	
	private static final String STACK_COLUMN = "STACK_C";
	...
	static{
		...
		typeDto.put(SCROLL_LINE, "ScrollLine2D.swf");
		typeDto.put(SCROLL_COLUMN, "ScrollColumn2D.swf");
		typeDto.put(STACK_COLUMN, "StackedColumn3D.swf");
	}
