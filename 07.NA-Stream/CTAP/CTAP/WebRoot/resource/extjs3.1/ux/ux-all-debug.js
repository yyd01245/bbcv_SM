...
// add the column to the column prod.nebula.model
...
var filters = new Ext.ux.grid.GridFilters({
    ...
    // or in the column definition within the column prod.nebula.model configuration
    filters: [{
        type: 'numeric',
        dataIndex: 'id'
    }, {
...
Ext.ux.grid.filter.Filter = Ext.extend(Ext.util.Observable, {
    ...
    /**
     * Destroys this filter by purging any event prod.nebula.listeners, and removing any menus.
     */
    destroy : function(){
        if (this.menu){
            this.menu.destroy();
