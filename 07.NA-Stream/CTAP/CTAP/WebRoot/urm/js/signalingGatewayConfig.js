...
Ext.onReady(function() {
	...
	Ext.Ajax.request({
	    url: './SignalingGetewayConfig.ered?reqCode=queryGatewayConfigList',
...
//					Ext.getCmp('perOffline').show();
				...
				myForm.form.load({
					...
					waitTitle : '提示',// 标题
					url : './SignalingGetewayConfig.ered?reqCode=queryGatewayConfig&nodeName='+nodeName ,//获取单个服务器信息
...
//															style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;', 
															...
															fieldLabel : '本服务工作IP', // 标签...本服务监听终端接入的端口
...
//															//style:'background : green;border:0 solid;border-bottom: #000000 1px solid;'
														...
														//	readOnly:true,
															...
															xtype : 'textfield', // 设置为文字输入框类型
														//	readOnly:true,
															emptyText : '本服务工作IP(与SM交互的IP),处理多网卡情况',
														//	labelStyle : 'color:blue;',
															anchor : '90%'
															//style:'background : none;border:0 solid;border-bottom: #000000 1px solid;'
														},{
...
//															//style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;',
												...
												,{
															fieldLabel : '监听SM的端口', // 标签        交互网关在接入网关的
															name : 'field6', // name:后台根据此name属性取值
															allowBlank : true,
															//readOnly:true,
															emptyText : '本服务监听SM的端口',
														//	labelStyle : 'color:blue;',
//															//style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;',
															//style:'background : none;border:0 solid;border-bottom: #000000 1px solid;',
															anchor : '90%'// 宽度百分比
															...
															fieldLabel : 'redis server的ip地址', // 标签        交互网关在接入网关的
															name : 'field6', // name:后台根据此name属性取值
															allowBlank : true,
															//readOnly:true,
...
//															//style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;',
															...
															fieldLabel : 'redis server端口', // 标签        交互网关在接入网关的
															name : 'field6', // name:后台根据此name属性取值
															allowBlank : true,
															//readOnly:true,
...
//															//style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;',
															...
															fieldLabel : 'redis server密码', // 标签        交互网关在接入网关的
															name : 'field6', // name:后台根据此name属性取值
															allowBlank : true,
															//readOnly:true,
...
//															//style:'background : blue;border:0 solid;border-bottom: #000000 1px solid;',
															...
															fieldLabel : 'redis连接池数目', // 标签        交互网关在接入网关的
															name : 'field6', // name:后台根据此name属性取值
															allowBlank : true,
															//readOnly:true,
...
//															//style:'background : green;border:0 solid;border-bottom: #000000 1px solid;'
														...
														//	readOnly:true,
															...
															readOnly:true,
															labelStyle : 'color:blue;',
															emptyText : '信令网关向接入网关发送心跳频率(单位:ms)'
															//style:'background : none;border:0 solid;border-bottom: #000000 1px solid;'
														},{
															fieldLabel : '信令网关的HID键值表配置目录',
															name : 'field8',
															xtype : 'textfield', // 设置为文字输入框类型
														//	readOnly:true,
															anchor : '100%',
															readOnly:true,
															labelStyle : 'color:blue;',
															emptyText : '信令网关的HID键值表配置目录'
															//style:'background : none;border:0 solid;border-bottom: #000000 1px solid;'
														},{
															fieldLabel : '终端接入的处理线程数',
															name : 'field8',
															xtype : 'textfield', // 设置为文字输入框类型
														//	readOnly:true,
															anchor : '100%',
...
//			var addCabinetWindow = new Ext.Window({});
			...
			function modifyConfig(){
				...
				if (myForm.form.isValid()) {
					myForm.form.submit({
					url : './SignalingGetewayConfig.ered?reqCode=updateAccessGatewayConfig',//调用crsm接口，保存服务器配置
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
					success : function(form, action) {
