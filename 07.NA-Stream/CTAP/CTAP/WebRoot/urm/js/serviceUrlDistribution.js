	...
	Ext.Msg.maxWidth = 360;
			...
			var store = new Ext.data.Store({
					...
					proxy : new Ext.data.HttpProxy({
								url : './ServiceUrlDistribution.ered?reqCode=queryAds'
							}),
					// 数据读取器
			...
			var grid = new Ext.grid.GridPanel({
						...
						title : '<span style="font-weight:bold;">服务地址列表</span>',
						height : 300,
						autoScroll : true,
						frame : true,
						store : store, // 数据存储
