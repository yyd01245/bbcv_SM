...
Ext.onReady(function() {
	...
	Ext.Msg.maxWidth =360 ;
			...
			var grid = new Ext.grid.GridPanel({
						title : '<span style="font-weight:bold;">会话监控</span>',
			...
			function killSession() {
				...
				if (Ext.isEmpty(rows)) {
					Ext.Msg.show({title:'提示',msg:'请先选中杀死的会话!',buttons:Ext.Msg.OK,icon:Ext.Msg.WARNING});
					return;
				}
				...
				Ext.Ajax.request({
							...
							success : function(response) {
								...
								refreshSessionTable();
								Ext.Msg.show({title:'提示',msg:resultArray.msg,icon:Ext.Msg.INFO});
							},
