 ...
 *    
 */
public class MbHomeServlet extends HttpServlet {

	/**
	 *  @Fields serialVersionUID : TODO(��һ�仰�������������ʾʲô)
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(MbHomeServlet.class);
	/**
	 * Constructor of the object.
	 */
	public MbHomeServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		   ...
		   if("preUpdateUrl".equals(method)){
	    	...
	    	MbHomeService ts = new MbHomeService();
	    	MobileMainPage tvNavigate= ts.getTvNavigate(id);
	    	
	    	 request.setAttribute("tvNavigate", tvNavigate);
	    	request.getRequestDispatcher("mb_home_add_update.jsp").forward(request, response);  
		   ...
		   if("updateUseState".equals(method)){
	    	   ...
	    	   MobileMainPage tn = new MobileMainPage();
	...
	public void listAndPage(HttpServletRequest request, HttpServletResponse response,int  currentPage,String ascendName  ,String ascending ,String urlKey){
		...
		MbHomeService tns = new MbHomeService();

	    List<MobileMainPage> list =	tns.findTNList(page, ascendName  , ascending , urlKey);
	   ...
	   logger.info("TotalRecords="+totalRecofds);
		...
		try {
			request.getRequestDispatcher("mb_home_page.jsp").forward(request, response);
