 ...
 *    
 */
public class MbDetailServlet extends HttpServlet {

	/**
	 *  @Fields serialVersionUID : TODO(��һ�仰�������������ʾʲô)
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(MbDetailServlet.class);
	/**
	 * Constructor of the object.
	 */
	public MbDetailServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		   ...
		   if("preUpdateUrl".equals(method)){
	    	...
	    	MbDetailService ts = new MbDetailService();
	    	MobileDetailPage tvNavigate= ts.getTvNavigate(id);
	    	
	    	 request.setAttribute("tvNavigate", tvNavigate);
	    	request.getRequestDispatcher("mb_detail_add_update.jsp").forward(request, response);  
		   ...
		   if("updateUseState".equals(method)){
	    	   ...
	    	   MobileDetailPage tn = new MobileDetailPage();
	...
	public void listAndPage(HttpServletRequest request, HttpServletResponse response,int  currentPage,String ascendName  ,String ascending ,String urlKey){
		...
		MbDetailService tns = new MbDetailService();

	    List<MobileDetailPage> list =	tns.findTNList(page, ascendName  , ascending , urlKey);
	   ...
	   logger.info("TotalRecords="+totalRecofds);
		...
		try {
			request.getRequestDispatcher("mb_detail_page.jsp").forward(request, response);
