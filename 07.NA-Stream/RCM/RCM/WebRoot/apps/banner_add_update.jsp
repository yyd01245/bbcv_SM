...
<html>
  ...
  <br>
   ...
   <form name="ydxmForm" method="post" action="apps/BannerServlet?method=${method}">
     ...
     <table width="70%"  cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<br/></td>
			<td class="tab01" >
			<input type="text" style="width: 300px;" name="bannerName" value="${tvNavigate.bannerName}">
			<br/></td>
		</tr>
		<tr>
			<td nowrap class="tab02" align="right">
			...
			<br/></td>
			<td class="tab01" >
			<input type="text" style="width: 300px;" name="itemNum" value="${tvNavigate.itemNum}">
			<br/></td>
		</tr>
