...
public class RedisImpl implements RedisInterface {
	...
	public RedisImpl() throws Exception {

		String redisPasswd = core.getConfig().getMtpRedisPass();
		...
		if (StringUtil.assertNotNull(redisPasswd)) {
			...
			jedisPool = new JedisPool(new JedisPoolConfig(), core.getConfig()
					.getMtpRedisIP(), core.getConfig().getMtpRedisPORT(), 2000,
					core.getConfig().getMtpRedisPass());
