...
Ext.onReady(function() {
	...
	var grid = new Ext.grid.GridPanel({
				title : '<span style="font-weight:bold;">字典数据列表</span>',
	...
	function ininEditCodeWindow() {
		...
		if (Ext.isEmpty(record)) {
			Ext.Msg.show({title:'提示',	msg:'请先选中要修改的项目!',	buttons:Ext.Msg.OK,icon:Ext.Msg.WARNING});
			return;
		}
					...
					if (btn == 'yes') {
						...
						Ext.Ajax.request({
									...
									failure : function(response) {
										Ext.Msg.show({title:'提示',	msg:'内存同步失败!',	buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});
									}
								});
					}
				});
