	...
	public void action() {
		...
		if(hasParamErrors()){
			...
			try {
				...
				case 1:
					if("weixin".equals(type)||"weixin"==type){
						resp.setMessage(UcmsConfig.wec_unbanding_message);
					}else{
				...
				case 2:
					if("weixin".equals(type)||"weixin"==type){
						resp.setMessage(UcmsConfig.wec_banding_message+userinfo.getChannel_id());
					}else{
				...
				case 3:
					if("weixin".equals(type)||"weixin"==type){
						resp.setMessage(UcmsConfig.wec_play_message+userinfo.getChannel_id());
					}else{
				...
				case 0:
					if("weixin".equals(type)||"weixin"==type){
						resp.setMessage(UcmsConfig.wec_user_unable_message);
					}else{
