...
public class UserInfoServiceImpl implements UserInfoService {
	...
	public Integer addUserInfo(String username,String passwd) throws SQLException {
		if(!checkUserInfo(username)) {
			...
			userInfo.setUser_status(UcmsConfig.unbanding_status);
...
//		}
	...
	public Integer updateUserVodPage(String username,String vod_page,String stream_id,String channel_id,int status) throws SQLException {
		UserInfo userInfo = new UserInfo(username);
		userInfo.setUsername(username);
//		userInfo.setVod_page(vod_page);
		userInfo.setStream_id(stream_id);
		userInfo.setChannel_id(channel_id);
		userInfo.setUser_status(status);
		return userInfoDao.updateUserInfoByUsername(userInfo,username);
}
	...
	public Integer unBindUser(String username) throws SQLException {
		UserInfo userInfo = new UserInfo(username);
		userInfo.setUsername(username);
		userInfo.setVod_page("");
		userInfo.setStream_id("");
		userInfo.setChannel_id("");
		userInfo.setUser_status(UcmsConfig.unbanding_status);
		return userInfoDao.updateUserInfoByUsername(userInfo,username);
	}
