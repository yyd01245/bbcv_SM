...
function test_user_updateNickname_req(){
	$("#user_updateNickname_req_res").val("");
	var username = $("#username").val();
	var passwd = $("#passwd").val();
	var nickname = $("#nickname").val();
	var res = MSI.user_updateNickname_req(username,passwd,nickname);
	$("#ret_code").val(res.ret_code);
	$("#user_updateNickname_req_res").val(JSON.stringify(res));
}
...
function test_user_vodplay_req(){
	...
	var res = MSI.user_vodplay_req(username,token,url);
	$("#token").val(res.new_token);
	$("#new_token").val(res.new_token);
