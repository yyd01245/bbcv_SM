...
MSI.user_updateNickname_req=function(username,passwd,nickname){
	var res = null;
	$.ajax({
		type:"POST",url:_basePath+"user_updateNickname_req.do",data:{
			sequence:sequence(),username:username,passwd:passwd,nickname:nickname
		}
		,async:false,success:function(data,textStatus){
			res = data;
		}
...
MSI.user_vodplay_req=function(username,token,url){
	var res = null;
	$.ajax({
		type:"POST",url:_basePath+"user_vodplay_req.do",data:{
			sequence:sequence(),username:username,token:token,url:url
		}
		,async:false,success:function(data,textStatus){
			res = data;
		}
