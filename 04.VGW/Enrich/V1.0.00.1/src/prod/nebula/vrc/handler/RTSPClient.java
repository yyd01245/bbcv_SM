...
//	public String pidInfo;
	 ...
	 */
	//ipqam地址
	public String ipqamIp;
	//ipqam端口
	public String ipqamPort;
	//ipqam对应频点
...
//					float currTime = bt+()
	...
	public void doTeardown() {
		...
		sb.append("TEARDOWN ");
		sb.append(this.address.substring(0, address.lastIndexOf("?")));//enrich修改
		sb.append("/");
		sb.append(VERSION);
		sb.append("CSeq: ");
		sb.append(seq++);
		sb.append("\r\n");
		sb.append("User-Agent: Onewave HFC-Player V1.1\r\n");
		sb.append("Session: ");
		sb.append(sessionid);
		sb.append("\r\n");
	...
	public void doPlay() {
		...
		/***********enrich修改开始**************/
		sb.append("\r\n");
		sb.append("Range: npt=0.000000-");
		sb.append("\r\n");
		sb.append("x-prebuffer: maxtime=20.00");
		sb.append("\r\n");
		sb.append("Scale:");
		sb.append("1.0");
		sb.append("\r\n");
...
//		sb.append("Transport: MP2T\r\n");
		sb.append("Transport: MP2T/TCP;interleaved=0-1\r\n");	//enrich修改
		sb.append("\r\n");
		if (ctrl.getOperHis() != null)
	...
	public void doOption() {
		...
		sb.append("rtsp://" + tmp.substring(0, tmp.lastIndexOf("/")));		//enrich修改
//		sb.append("rtsp://" + tmp.substring(0, tmp.lastIndexOf("?")));
		sb.append(VERSION);
//		sb.append("Accept: application/sdp");	//enrich修改
//		sb.append("\r\n");						//enrich修改
		sb.append("CSeq: ");
		sb.append(seq++);
		sb.append("\r\n");
		sb.append("User-Agent: Onewave HFC-Player V1.1");
//		sb.append("\r\n");						//enrich修改
//		sb.append("x-RegionID: ");				//enrich修改
//		sb.append(this.regionId);				//enrich修改
		sb.append("\r\n");
		sb.append("\r\n");
		if (ctrl.getOperHis() != null)
...
//		sb.append(this.regionId);				//enrich修改
	...
	public void doDescribe() {
		...
		sb.append(this.pid);
		sb.append("&ip=");
		sb.append(this.ipqamIp);
		sb.append("&port=");
		sb.append(this.ipqamPort);
		sb.append("serialno=");
