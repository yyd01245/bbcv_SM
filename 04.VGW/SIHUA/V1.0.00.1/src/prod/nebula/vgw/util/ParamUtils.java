...
public class ParamUtils {
     ...
     * @return The String value of the parameter specified or the default value if
	...
	public static String getParameter( Map<String, Object> params, String paramName, String defaultStr ) {
		String ret = null;
		if(params!=null&&params.get(paramName)!=null){
			try{
				String temp = String.valueOf(params.get(paramName));
		        if( temp == null || temp.equals("")) {
					return defaultStr;
		        }
		        else {
