 ...
 * 
 */
package prod.nebula.vgw.module.resdis;
...
import prod.nebula.vgw.module.resdis.dao.VCAResDisDao;
	...
	public void startPlayer(VODResDisReqBean bean, IoSession session)
		...
		try {
			...
			logger.debug("【VOD网关】appUserId=" + appUserId + " sessionId="
					...
					+ " rtsp=" + rtspUrl+"vodname="+vodname+"posterurl="+posterurl+" localIpAddress="+localIpAddress);
