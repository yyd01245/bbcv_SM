...
import prod.nebula.vgw4sida.handler.RtspPlayClient;
import prod.nebula.vgw4sida.handler.UDPHandler;
...
public class Controller implements Serializable, Runnable {
	...
	private HashMap<Integer, Commons.Status> setupoperHis;
	...
	//new
	private String OnDemandSessionId;
	private String ClientSessionId;
	private RtspPlayClient playClient;
	//播放影片名
	...
	public void setOnDemandSessionId(String onDemandSessionId) {
	...
	public RtspPlayClient getPlayClient() {
		return playClient;
	}

	public void setPlayClient(RtspPlayClient playClient) {
		this.playClient = playClient;
	}

	
	
	public HashMap<Integer, Commons.Status> getSetupoperHis() {
		return setupoperHis;
	}

	public void setSetupoperHis(HashMap<Integer, Commons.Status> setupoperHis) {
		this.setupoperHis = setupoperHis;
	}
