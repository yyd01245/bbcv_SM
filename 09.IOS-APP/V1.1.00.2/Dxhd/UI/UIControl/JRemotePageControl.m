...
@implementation JRemotePageControl
...
- (id)initWithType:(JPageControlType)theType
{
...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < numberOfPages; i++)
	{
		...
		if (i == currentPage)
		{
			if (type == JPageControlTypeOnFullOffFull || type == JPageControlTypeOnFullOffEmpty)
            {
		...
		{
			if (type == JPageControlTypeOnEmptyOffEmpty || type == JPageControlTypeOnFullOffEmpty)
			{
...
- (void)setType:(JPageControlType)aType
{
	type = aType;
