...
- (void)keyboardWillShow:(NSNotification *)notification
{
    if (self.loginScrollView.contentOffset.y == 0) {
        ...
        [self.loginScrollView setContentOffset:CGPointMake(0, 146.) animated:YES];
    }
}
...
- (IBAction)actionIPConfig:(id)sender
{
    [JDC presentIPConfigViewControllerFormViewController:self];
}
...
{
    [[JMessageHUD shareInstance] showWithMessage:@"无效的服务器地址！"];
    
    [JCO saveHostUrl:HOST_URL];
}
