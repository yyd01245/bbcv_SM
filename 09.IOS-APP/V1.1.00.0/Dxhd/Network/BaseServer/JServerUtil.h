...
//#define HOST_URL (@"http://10.169.8.29:18080")
#define HOST_URL (@"http://218.108.50.254:18080")

//#define HOST_URL (@"http://218.108.50.250:18080")
//#define HOST_URL (@"http://192.168.100.11:18080")
//#define HOST_URL (@"http://192.168.30.237:18080")

//#define DEFAULT_FLAG @"xxxxxx"

/********************** 返回结果 ***********************/
#define RETURN_SUCCESS            0           //启动成功
#define REQUEST_FAIL              @"连接失败，请检查网络状况！"
...
#define BlcIrrPropertyValue_BACK              @"0x1c"     //后退，返回
#define BlcIrrPropertyValue_EXIT              @"0x1d"     //退出
#define BlcIrrPropertyValue_PAGEDOWN          @"0x04"     //快退
#define BlcIrrPropertyValue_PAGEUP            @"0x08"     //快进
