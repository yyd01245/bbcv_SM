...
{
    switch (index) {
        case 0:[JDC presentUserManagerViewControllerFormViewController:self];
            break;
        case 1:[JDC presentAboutViewControllerFormViewController:self];
            break;
