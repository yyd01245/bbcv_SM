/*填充幻灯片数据*/
var sliderdata=[
	{name:"关云长",href:"voddetail.html?name=gyc&openid="+getQueryStringByName("openid"),sliderposter:"images/gyc-big.jpg"},
	{name:"爱情公寓",href:"voddetail.html?name=aqgy&openid="+getQueryStringByName("openid"),sliderposter:"images/aqgy-big.jpeg"},
	{name:"营盘镇警事",href:"voddetail.html?name=ypzjs&openid="+getQueryStringByName("openid"),sliderposter:"images/ypzjs-big.jpg"}
];

/*填充不同分类下的电影信息*/
var data={
	0:{class:"推荐",morelink:"vod.html?class="+encodeurl("推荐"),resource:[
		{
			id:"gyc",
			rid: "1",
			name:"关云长",
	...
	1:{class:"电影",morelink:"vod.html?class="+encodeurl("电影"),resource:[
		{
			id:"gyc",
			rid: "1",
			name:"关云长",
