...
$actionSearch[0] =array(
    ...
    'soniterm' =>  array(
        ...
        2  =>  array(
            'title' =>'我发布的内容',
            'description' =>'现在登录的管理员所发表的所有内容模型中的内容',
        ...
        4  =>  array(
            'title' =>'内容回收站',
            'description' =>'如果在"系统基本参数"的"核心设置"中开启了"内容回收站(是/否)开启功能",后台删除的内容将会存放在此处',
            'purview' =>'a_List,a_AccList,a_MyList',
...
$actionSearch[3] = array(
    ...
    'soniterm' => array(
        0  =>  array(
            'title' =>'内容模型管理 ',
            'description' =>'可以对现有商品、软件、图片集、普通内容、专题、分类信息等模型就行管理，也可以创建新的内容模型',
            'purview' =>'c_List',
...
$actionSearch[4] = array(
    ...
    'soniterm' => array(
        ...
        1  =>  array(
            'title' =>'内容批量维护 ',
            'description' =>'批量的对某个栏目或者全部栏目的内容进行审核内容、更新HTML、移动内容、删除内容',
            'purview' =>'sys_ArcBatch',
        ...
        3  =>  array(
            'title' =>'内容关键词维护 ',
            'description' =>'对内容中的关键词进行批量的维护',
            'purview' =>'sys_Keyword',
            'linkurl' =>'article_keywords_main.php'
        ),
        4  =>  array(
            'title' =>'重复内容检测 ',
            'description' =>'可以对网站中出现的重复标题的内容进行处理',
            'purview' =>'sys_ArcBatch',
            'linkurl' =>'article_test_same.php'
        ),
        5  =>  array(
            'title' =>'自动摘要|分页 ',
            'description' =>'用于自动更新您系统没有填写摘要的内容的摘要信息或更新没分页的内容的自动分页标识',
            'purview' =>'sys_Keyword',
...
$actionSearch[5] = array(
    ...
    'soniterm' => array(
        0  =>  array(
            'title' =>'注册会员列表',
            'description' =>'所有注册会员的管理项,其中包含修改,删除,查看会员内容以及提升管理员等操作',
            'purview' =>'member_List',
...
$actionSearch[8] = array(
    'toptitle' => '生成', 
    'title' => 'HTML更新',
    'description' => '针对主页、栏目、内容、专题等等进行更新',
    'soniterm' => array(
        0  =>  array(
            'title' =>'更新主页HTML',
        ...
        2  =>  array(
            'title' =>'更新内容HTML',
            'description' =>'对每个栏目下的内容进行静态HTML页面的生成',
            'purview' =>'sys_MakeHtml',
...
$actionSearch[10] = array(
    ...
    'soniterm' => array(
        ...
        6  =>  array(
            'title' =>'自定义内容属性',
            'description' =>'在以往的版本中，网站主页、频道封面的设计，都只能单调的用 arclist 标记把某栏目最新或按特定排序方式的内容无选择的读出来，这样做法存在很大的不足，在发布的时候对适合的内容选择专门的属性，那么使用arclist的地方就会按您的意愿显示指定的内容。',
            'purview' =>'sys_Att',
        ...
        9  =>  array(
            'title' =>'随机模板设置',
            'description' =>'本设置仅适用于系统默认的内容模型，设置后发布内容时会自动按指定的模板随机获取一个，如果不想使用此功能，把它设置为空即可！',
            'purview' =>'sys_StringMix',
