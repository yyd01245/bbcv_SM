...
if($cuserLogin->getUserType() >= 10)
{
  ...
  <m:item name='单页内容管理' link='templets_one.php' rank='temp_One' target='main'/>
...
<m:top item='10_' name='系统设置' display='none' rank='sys_User,sys_Group,sys_Edit,sys_Log,sys_Data'>
  ...
  <m:item name='自定义内容属性' link='content_att.php' rank='sys_Att' target='main' />
...
<m:top item='1_' name='常用操作' display='block'>
  ...
  <m:item name='我发布的内容' link='content_list.php?mid=".$cuserLogin->getUserID()."' rank='a_List,a_AccList,a_MyList' target='main' />
...
<m:top item='1_3_3' name='批量维护' display='block'>
  ...
  <m:item name='内容批量维护' link='content_batch_up.php' rank='sys_ArcBatch' target='main' />
  <m:item name='搜索关键词维护' link='search_keywords_main.php' rank='sys_Keyword' target='main' />
  <m:item name='内容关键词维护' link='article_keywords_main.php' rank='sys_Keyword' target='main' />
  <m:item name='重复内容检测' link='article_test_same.php' rank='sys_ArcBatch' target='main' />
...
<m:top item='5_' name='HTML更新' notshowall='1' display='none' rank='sys_MakeHtml'>
  ...
  <m:item name='更新内容HTML' link='makehtml_archives.php' rank='sys_MakeHtml' target='main' />
