...
function ShowMenu(evt,obj,aid,atitle)
{
  var popupoptions
  popupoptions = [
    new ContextItem("浏览内容",function(){ viewArc(aid); }),
		new ContextItem("编辑属性",function(){ QuickEdit(aid, evt, obj); }),
    new ContextItem("编辑内容",function(){ editArc(aid); }),
    new ContextSeperator(),
    new ContextItem("更新HTML",function(){ updateArc(aid); }),
    new ContextItem("审核内容",function(){ checkArc(aid); }),
    new ContextItem("推荐内容",function(){ adArc(aid); }),
    new ContextItem("删除内容",function(){ delArc(aid); }),
    new ContextSeperator(),
