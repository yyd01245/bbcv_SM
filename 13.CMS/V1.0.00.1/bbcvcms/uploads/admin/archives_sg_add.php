...
else if($dopost=='save')
{
    ...
    if(empty($channelid))
    {
        ShowMsg("内容为非指定的类型，请检查你发布内容的表单是否合法！","-1");
        exit();
    }
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='archives_sg_add.php?cid=$typeid'><u>继续发布内容</u></a>
    &nbsp;&nbsp;
    <a href='$artUrl' target='_blank'><u>查看内容</u></a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$arcID."&dopost=editArchives'><u>更改内容</u></a>
    &nbsp;&nbsp;
    <a href='content_sg_list.php?cid=$typeid&channelid={$channelid}&dopost=listArchives'><u>已发布内容管理</u></a>
    &nbsp;&nbsp;
