...
class Archives
{
    ...
    function __construct($aid)
    {
        ...
        else
        {
            ...
            if(empty($assigntypeid)){
                $this->TypeLink = new TypeLink($arr['typeid']);
            }
            else {
                $this->TypeLink = new TypeLink($assigntypeid);
            }
    ...
    {
        global $cfg_basedir,$cfg_templets_dir,$cfg_df_style,$assigntypeid;
        ...
        $tid = empty($assigntypeid) ? $this->Fields['typeid'] : $assigntypeid;
