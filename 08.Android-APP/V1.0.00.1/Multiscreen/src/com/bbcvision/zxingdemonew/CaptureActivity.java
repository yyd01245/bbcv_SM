package com.bbcvision.zxingdemonew;
...
import com.bbcvision.zxingdemonew.zxing.decoding.CaptureActivityHandler;
import com.bbcvision.zxingdemonew.zxing.decoding.InactivityTimer;
import com.bbcvision.zxingdemonew.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void initAnimation() {
		...
		//TranslateAnimation mAnimation = new TranslateAnimation(frame.left, frame.left, frame.top +UIUtils.px2dip(320), frame.bottom - UIUtils.px2dip(300));
		TranslateAnimation mAnimation = new TranslateAnimation(frame.left, frame.left, height*3/9, height*5/9);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			Editor ed = sp.edit();
			ed.putString("scanMsg", resultString);
			ed.commit();
