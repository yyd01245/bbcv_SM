...
public class LoginItemView extends RelativeLayout {
	...
	public LoginItemView(Context context, AttributeSet attrs) {
		...
		String desc = attrs.getAttributeValue("http://schemas.android.com/apk/res/com.bbcvision.Multiscreen", "desc");
		String input = attrs.getAttributeValue("http://schemas.android.com/apk/res/com.bbcvision.Multiscreen ", "input");
		String isPwd = attrs.getAttributeValue("http://schemas.android.com/apk/res/com.bbcvision.Multiscreen ", "pwd");
		setText(input);
		setDescText(desc);
		if(isPwd != null){
			isPassword(true);
